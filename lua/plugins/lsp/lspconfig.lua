return {
    ...
    config = function()
        ...
        local on_attach = function(client, bufnr)
            -- LSP shortcuts
            vim.keymap.set("n", "gR", "<cmd>Telescope lsp_references<CR>", { desc = "Show LSP references", noremap = true, silent = true }) -- show definition, references
            vim.keymap.set("n", "gD", vim.lsp.buf.declaration, { desc = "Go to declaration", noremap = true, silent = true }) -- go to declaration
            ...
            vim.keymap.set("n", "[d", vim.diagnostic.goto_prev, { desc = "Go to previous diagnostic", noremap = true, silent = true }) -- Jump to previous diagnostic in buffer
            vim.keymap.set("n", "]d", vim.diagnostic.goto_next, { desc = "Go to next diagnostic", noremap = true, silent = true }) -- Jump to previous diagnostic in buffer
            vim.keymap.set("n", "K", vim.lsp.buf.hover, { desc = "Show documentation for what is under cursor", noremap = true, silent = true }) -- show docs for what is under cursor
            vim.keymap.set("n", "<leader>rs", "<cmd>LspRestart<CR>", { desc = "Restart LSP", noremap = true, silent = true }) -- restart LSP
        end
